          ...
          $modal.open = function (modalOptions) {
            ...
            modalInstance.rendered.then(function () {
              var $modal_dialog = $('.modal-content'),
                  m_top;
              if($modal_dialog.length>1){
                $modal_dialog = $($modal_dialog[$modal_dialog.length-1]);
              }
              if($(window).height()>$modal_dialog.height()){
                m_top = ( $(window).height() - $modal_dialog.height() )/2;
              }else{
                m_top = 30;
              }
              //m_top = ( $(document).height() - $modal_dialog.height() )/2;
...
angular.module("template/modal/window.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/modal/window.html",
    ...
    "    <div class=\"modal-content-iot\" uib-modal-transclude></div>\n" +
    "</div>\n" +
    "");
}]);
